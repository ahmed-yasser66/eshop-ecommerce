  ...
  return (
    <Modal>
      ...
      <Modal.Window
        ...
        preventScroll
      >
        <div className="w-[90vw] max-w-screen-md xl:w-[55vw] block z-10 absolute top-1/2 left-1/2 [transform:translate(-50%,-50%)]">
          <Modal.Toggler>
            <div className="absolute -right-14 top-0 text-4xl font-bold hover:bg-[--color-secondary] size-12 text-center leading-[48px] rounded-md cursor-pointer [@media(max-width:1023px)]:hidden">
              &times;
            </div>
          </Modal.Toggler>
